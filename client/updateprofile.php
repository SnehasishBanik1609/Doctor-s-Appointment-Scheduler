...
<div class="container-fluid pt-2 pb-2" style="background-color:rgba(209, 209, 170,0.3);">
    <div class="row">
        <div class="col-sm-10 ">
        <a href="dashboard.php"> <img  width="150" class="ml-0 mt-2 mb-2" src="../images/logo1.jpg"> </a>
        </div>
...
<form class="my-5 mx-auto w-50" method="post" name="login" action="">
  ...
  <div class="form-group" >
    ...
    <input type="tel" class="form-control" name="phno" placeholder="new phone number" pattern="[0-9]{3}[0-9]{3}[0-9]{4}" Title="Must contain only 10 digits" required>
  </div>

  <div class="form-group" >
    <label>Enter Blood Group</label>
     <select name="bg" id="blood-group">
